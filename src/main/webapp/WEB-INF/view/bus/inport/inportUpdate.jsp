...
<head>
    ...
    <title>修改商品进货</title>
    <link rel="stylesheet" href="${simonBasePath }/resources/layui/css/layui.css"
          media="all"/>
    <link rel="stylesheet" href="${simonBasePath }/resources/css/public.css"
          media="all"/>
...
<form class="layui-form" method="post" id="frm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" name="inportprice" placeholder="进货价格" value="${inport.inportprice }"
...
<script type="text/javascript">
    layui.use(['form', 'jquery', 'layer'], function () {
        ...
        form.on('submit(addInport)', function (data) {
            ...
            //使用ajax提交
            $.ajax({
                url: '${simonBasePath }/inport/addInport.action',
                type: 'POST',
        ...
        function initGoodsName(providerid) {
            var url = "${simonBasePath}/goods/loadGoodsByProviderId.action"
