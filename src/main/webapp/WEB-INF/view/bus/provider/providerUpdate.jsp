    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" name="providername" value="${provider.providername }" lay-verify="required"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="telephone" value="${provider.telephone }" placeholder="公司电话" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" name="zip" value="${provider.zip }" placeholder="邮编" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    layui.use(['form', 'jquery', 'layer'], function () {
        ...
        form.on('submit(updateProvider)', function (data) {
            ...
            //使用ajax提交
            $.ajax({
                url: '${simonBasePath }/provider/updateProvider.action',
                type: 'POST',
