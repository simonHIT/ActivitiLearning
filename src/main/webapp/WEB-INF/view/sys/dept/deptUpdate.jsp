...
<form class="layui-form" id="deptFrm">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="ordernum" lay-verify="required" value="${deptVo.ordernum }" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" value="${deptVo.name }" placeholder="请输入部门名称"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="loc" value="${deptVo.loc }" placeholder="请输入部门地址" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer', 'jquery'], function () {
        ...
        form.on('submit(updateDept)', function (data) {
            ...
            //使用ajax提交
            $.ajax({
                url: '${simonBasePath}/dept/updateDept.action',
                type: 'POST',
