...
<form class="layui-form" id="userFrm">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="ordernum" lay-verify="required" value="${userVo.ordernum }" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="name" value="${userVo.name }" id="name" lay-verify="required"
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="loginname" value="${userVo.loginname }" id="loginname" lay-verify="required"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="remark" value="${userVo.remark }" placeholder="请输入用户备注" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" name="hiredate"
                       value="<fmt:formatDate value="${userVo.hiredate }" pattern="yyyy-MM-dd"/>" id="hiredate"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $.post("${simonBasePath}/dept/loadDeptLeftTree.action?available=1", function (zNodes) {
            ...
            var mgr =${userVo.mgr};
            //根据领导的ID查询领导的部门ID
            $.post("${simonBasePath}/user/loadUserById.action", {id: mgr}, function (user) {
        ...
        //给用户名修改失去焦点事件
        $("#name").blur(function () {
            $.post("${simonBasePath}/user/changeUserNameToPinyin.action", {name: this.value},
                function (obj) {
    ...
    function initLeaderNames(leaderdeptId) {
        $.post("${simonBasePath}/user/loadUserByDeptId.action", {deptid: leaderdeptId}, function (obj) {
            var msg = $("#mgr");
            var html = "";
            var mgr =${userVo.mgr};
    ...
    layui.use(['form', 'layer', 'jquery', 'laydate'], function () {
        ...
        form.on('submit(updateUser)', function (data) {
            ...
            //使用ajax提交
            $.ajax({
                url: '${simonBasePath}/user/updateUser.action',
                type: 'POST',
