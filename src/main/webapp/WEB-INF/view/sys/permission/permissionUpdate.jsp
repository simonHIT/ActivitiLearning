...
<form class="layui-form" id="permissionFrm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name" lay-verify="required" value="${permissionVo.name }" placeholder="请输入权限名称"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="percode" placeholder="请输入权限编码" value="${permissionVo.percode }" autocomplete="off"
                   class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer', 'jquery'], function () {
        ...
        form.on('submit(updatePermission)', function (data) {
            ...
            //使用ajax提交
            $.ajax({
                url: '${simonBasePath}/permission/updatePermission.action',
                type: 'POST',
