...
<head>
    ...
    <script type="text/javascript" src="${simonBasePath }/resources/zTree/js/jquery.ztree.excheck.min.js"></script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".search_btn").click(function () {
            ...
            //得到选中的节点
            $.ajax({
                url: '${simonBasePath}/role/saveRolePermission.action',
                type: 'POST',
    ...
    function initTree() {
        //使用ajaxt去请求权限的json
        $.post("${simonBasePath}/role/loadRolePermission.action?id=${roleVo.id}",
            function (zNodes) {
