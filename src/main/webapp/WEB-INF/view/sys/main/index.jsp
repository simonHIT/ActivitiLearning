...
<head>
    ...
    <link rel="stylesheet" href="${ simonBasePath}/resources/css/index.css" media="all"/>
</head>
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${ simonBasePath}/resources/images/face.jpg"
                                                class="layui-nav-img userAvatar" width="35" height="35"><cite
                            class="adminName">${user.name }</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${ simonBasePath}/resources/page/user/userInfo.html"><i
                                class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="${ simonBasePath}/resources/page/user/changePwd.html"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${ simonBasePath}/resources/images/face.jpg" class="userAvatar"></a>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${ simonBasePath}/desk/toDeskManager.action"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2019 Simon</span></p>
    </div>
</div>
...
<script type="text/javascript" src="${ simonBasePath}/resources/js/cache.js"></script>

<script type="text/javascript">
    var $, tab, dataStr, layer;
    layui.config({
        base: "${ simonBasePath}/resources/js/"
    }).extend({
        "bodyTab": "bodyTab"
    })
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${ simonBasePath}/menu/loadIndexLeftTree.action" //获取菜单json地址
        });
