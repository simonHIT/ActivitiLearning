...
<script type="text/javascript">
    ...
    function getLangDate() {
        ...
        document.getElementById("nowTime").innerHTML = "亲爱的${user.name}，" + timeValue + "好！ 欢迎使用库存管理系统。当前时间为： " + newDate + "　" + week;
    ...
    layui.use(['form', 'element', 'layer', 'jquery'], function () {
        ...
        //最新公告列表
        $.post("${simonBasePath }/notice/loadAllNotices.action?page=1&limit=4", function (data) {
            var hotNewsHtml = '';
