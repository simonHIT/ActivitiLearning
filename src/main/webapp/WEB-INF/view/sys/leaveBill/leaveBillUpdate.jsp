...
<form class="layui-form" method="post" id="frm">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="tel" name="days" lay-verify="required|number" value="${leaveBill.days }" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                ...
                <input type="text" name="leavetime" id="leavetime"
                       value="<fmt:formatDate value="${leaveBill.leavetime }" pattern="yyyy-MM-dd"/>"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea placeholder="请输入请假单内容" name="content" id="content"
...
<script type="text/javascript">
    layui.use(['form', 'jquery', 'layer', 'laydate'], function () {
        ...
        form.on('submit(updateLeaveBill)', function (data) {
            ...
            //使用ajax提交
            $.ajax({
                url: '${simonBasePath}/leaveBill/updateLeaveBill.action',
                type: 'POST',
