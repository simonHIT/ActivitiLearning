...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer', 'table', 'laydate', 'laytpl'], function () {
        ...
        tableDeploymentIns = table.render({
            elem: '#deploymentList',
            url: '${simonBasePath }/workFlow/loadAllDeployment.action',
            cellMinWidth: 95,
        ...
        $(".search_btn").on("click", function () {
            ...
            table.reload('deploymentListTable', {
                url: '${simonBasePath }/workFlow/loadAllDeployment.action?' + params
            });
            table.reload('processDefinitionListTable', {
                url: '${simonBasePath }/workFlow/loadAllProcessDefinition.action?' + params
            });
        });
        //监听头工具栏事件
